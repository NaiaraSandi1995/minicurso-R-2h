...
![Formato](https://img.shields.io/badge/formato-virtual-2FBFA8?style=for-the-badge)
![Licença](https://img.shields.io/badge/licença-CC%20BY%204.0-F2B33D?style=for-the-badge)
...
|---|---|
| `scripts/` | Os scripts de cada dia, comentados linha por linha |
| `dados/` | As bases empíricas usadas nos exercícios |
| `slides/` | As apresentações das aulas |
| `exercicios/` | Atividades para praticar entre um encontro e outro |
| `ementa/` | Ementa completa e plano de aula |
...
<br>
Não. Você precisa saber o que quer perguntar aos dados; a conta o computador faz. O que a gente trabalha é a interpretação, não o cálculo.
</details>
<details>
<summary><b>Meu computador é fraquinho. Vai rodar?</b></summary>
<br>
Sim. O R é leve e roda bem em máquinas modestas, no Windows, no Mac e no Linux. Só evite fazer o curso pelo celular. 😉
</details>
<details>
...
Material didático distribuído sob licença [**CC BY 4.0**](https://creativecommons.org/licenses/by/4.0/deed.pt-br) — use, adapte e compartilhe à vontade, inclusive nas suas próprias aulas. Só peço que cite a autoria. 🙏
 
**Como citar:**
 
> ALCANTARA, Naiara Sandi de Almeida. *Introdução ao R para análise de dados em Ciência Política*. Belém: Universidade Federal do Pará, 2026.
...
Deixe uma estrela no repositório — ajuda outras pessoas a encontrarem.
 
*Feito com carinho, café e muita mensagem de erro no console.* ☕
